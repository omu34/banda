<x-app-layout>
    ...
    <div class="min-h-[500px]" style="background:url({{ asset('assets/images/resources-banner.webp') }});background-size: cover; background-position: center; background-repeat: no-repeat;">
