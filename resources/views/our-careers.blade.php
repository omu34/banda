<x-app-layout>
    @show
    @section('content')
    <div class="min-h-[500px]" style="background:url({{ asset('assets/images/careers-banner.webp') }});background-size: cover; background-position: center; background-repeat: no-repeat;">
        ...
        <div class="max-w-screen-xl mx-auto">
            ...
            <div class=" grid grid-cols-1 md:grid-cols-2 gap-16 pt-10">
                ...
                <div class="lg:justify-self-end md:justify-self-center justify-self-end">
                    <img class="" src="{{ asset('assets/images/working-image.webp') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div class="rounded-lg ">
                    <img class="" src="{{ asset('assets/images/work1.webp') }}">
                </div>
                <div class="rounded-lg ">
                    <img class="" src="{{ asset('assets/images/work2.webp') }}">
                </div>
                <div class="rounded-lg ">
                    <img class="" src="{{ asset('assets/images/work3.webp') }}">
                </div>
            </div>
            ...
            <div class="pb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    <div class="rounded-xl mt-8  " style="background: var(--Hues-Light-Blue, #99CFFF);height:fit-content">
                        <div class="p-4 ">
                            <div class="">
                                <img class="rounded-full w-10" style="background: var(--Brand-Dark-Blue, #005AA9);" src="{{ asset('assets/images/career-badge.webp') }}">
