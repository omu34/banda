<x-app-layout>
    ...
    <div class="">
        <div id="controls-carousel " class="relative w-full z-0" data-carousel="static">
            <div class="relative h-56  overflow-hidden  md:min-h-[500px] ">
                <div class="hidden  w-auto duration-700  ease-in-out bg-no-repeat bg-cover" style="background:url({{ asset('assets/images/home-banner.webp') }});background-size: cover; background-position: center; background-repeat: no-repeat;" data-carousel-item>
                ...
                <div class="hidden  w-auto duration-700  ease-in-out bg-no-repeat bg-cover" style="background:url({{ asset('assets/images/submit-banner.webp') }}); background-size: cover;" data-carousel-item>
                    <div class="flex max-w-screen-xl mx-auto">
                        <div class="justify-start md:mt-[80px] mt-4">
                            <div>
                                <h1 class="banner-word">
                ...
                <div class="hidden  w-auto duration-700  ease-in-out bg-no-repeat bg-cover" style="background:url({{ asset('assets/images/about.webp') }}); background-size: cover;" data-carousel-item>
                    <div class="flex max-w-screen-xl mx-auto">
                        <div class="justify-start md:mt-[80px] mt-4">
                            <div>
                                <h1 class="banner-word">
                ...
                <div class="hidden  w-auto duration-700  ease-in-out bg-no-repeat bg-cover" style="background:url({{ asset('assets/images/get-banner.webp') }}); background-size: cover;" data-carousel-item>
                    <div class="flex max-w-screen-xl mx-auto">
                        <div class="justify-start md:mt-[80px] mt-4">
                            <div>
                                <h1 class="banner-word">
                ...
                <div class="hidden  w-auto duration-700  ease-in-out bg-no-repeat bg-cover" style="background:url({{ asset('assets/images/resources-banner.webp') }}); background-size: cover;" data-carousel-item>
                    <div class="flex max-w-screen-xl mx-auto">
                        <div class="justify-start md:mt-[80px] mt-4">
                            <div>
                                <h1 class="banner-word">
            ...
            <div class="max-w-screen-xl mx-auto">
                <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                    <span class="inline-flex items-center justify-center w-10 h-10 rounded-full hover:bg-blue-900/60 ">
                        <img class="h-fit" src="{{ asset('assets/images/arrow_2.webp') }}">
                ...
                <button type="button" class="absolute top-0 end-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
                    <span class="inline-flex items-center justify-center w-10 h-10 rounded-full hover:bg-blue-900/60 ">
                        <img class="h-fit" src="{{ asset('assets/images/arrow.webp') }}">
    ...
    <div class="bg-white">
        <div class="max-w-screen-xl mx-auto  ">
            <div class=" grid grid-cols-1 md:grid-cols-2 gap-10 ">
                <div class="mt-[40px]">
                    ...
                    <div class=" mt-5">
                        <img class="w-full max-h-[680px]" src="{{ asset('assets/images/p-services.webp') }}">
            ...
            <div class=" grid grid-cols-1 md:grid-cols-2 gap-16 mt-[40px]">
                ...
                <div class="lg:justify-self-end md:justify-self-center justify-self-end">
                    <img class="" src="{{ asset('assets/images/shake-hands.webp') }}">
            ...
            <div class=" mt-[60px]">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10 ">
                    <div class="">
                        <p class=" why-1 -ml-5 uppercase font-bold text-sm   rounded-lg  px-5 py-2.5 text-center inline-flex items-center">
                            1. Ordinary Savings Account
                        </p>
                        <div class="mt-3">
                            <img class="" src="{{ asset('assets/images/image_3.webp') }}">
                        </div>
                    </div>
                    <div class="">
                        <div class="">
                        ...
                        <div class="mt-5">
                            <img class="" src="{{ asset('assets/images/image_2.webp') }}">

                        </div>
                    </div>
                    <div class="lg:justify-self-end md:justify-self-center justify-self-center">
                        <div class="">
                            <p class=" why-1 -ml-5 uppercase font-bold text-sm   rounded-lg  px-5 py-2.5 text-center inline-flex items-center">
                                3. Non-withdrawable Deposits
                            </p>
                        </div>
                        <div class="mt-5">
                            <img class="" src="{{ asset('assets/images/image_1.webp') }}">
                        </div>
                    </div>
                </div>
                <div class="flex justify-center mt-[20px]">
                    <button class="text-white uppercase bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                        more details
                        <svg class="w-2.5 h-2.5 ms-3 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4" />
                        </svg>
        ...
        <div class="max-w-screen-2xl mx-auto bg-slate-100  mt-[60px]">
                ...
                <div class="">
                    ...
                    <div class="mt-5">
                        <div class="flex justify-start">
                            <button style="" class="text-blue-400 uppercase ring-1 ring-blue-400  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">
                                see all
                                <svg class="w-2.5 h-2.5 ms-3 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4" />
                                </svg>
